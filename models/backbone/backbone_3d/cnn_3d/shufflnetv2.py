...
w_path = "E:\\study\\daima\\YOWOv2-master\\kinetics_shufflenetv2_0.25x_RGB_16_best.pth"
# model_urls = {
...
def channel_shuffle(x, groups):     #通道混洗
...
class ShuffleNetV2(nn.Module):
    def __init__(self, width_mult='0.25x', num_classes=600):
...
def load_weight(model, arch):
    ...
    checkpoint_state_dict = checkpoint.pop('state_dict') if 'state_dict' in checkpoint else checkpoint
...
if __name__ == '__main__':
    import time
    model, feat = build_shufflenetv2_3d(model_size='0.25x', pretrained=True)
